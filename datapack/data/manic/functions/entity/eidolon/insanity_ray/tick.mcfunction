...
execute unless score @s manic.dummy2 matches 1.. if entity @a[dx=0,gamemode=!creative,gamemode=!spectator,nbt=!{Health:0.0f}] run function manic:entity/eidolon/insanity_ray/damage/main
