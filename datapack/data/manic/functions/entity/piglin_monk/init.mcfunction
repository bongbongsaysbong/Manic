...
summon hoglin ~ ~ ~ {Age:-32767,Attributes:[{Name:generic.follow_range,Base:0},{Name:generic.attack_damage,Base:0}],Tags:["manic.entity","smithed.entity","manic.piglin_monk_hoglin"],Leashed:1b}
