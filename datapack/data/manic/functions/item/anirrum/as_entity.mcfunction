...
execute store success score #helmet manic.dummy if predicate manic:entity/wearing/anirrum/helmet run item replace entity @s armor.head with minecraft:leather_helmet
execute store success score #chestplate manic.dummy if predicate manic:entity/wearing/anirrum/chestplate run item replace entity @s armor.chest with minecraft:leather_chestplate
execute store success score #leggings manic.dummy if predicate manic:entity/wearing/anirrum/leggings run item replace entity @s armor.legs with minecraft:leather_leggings
execute store success score #boots manic.dummy if predicate manic:entity/wearing/anirrum/boots run item replace entity @s armor.feet with minecraft:leather_boots
