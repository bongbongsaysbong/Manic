...
execute if entity @s[tag=manic.heretic] run playsound manic:entity.heretic.hurt hostile @a
execute if entity @s[tag=manic.zealot] run playsound manic:entity.zealot.hurt hostile @a
