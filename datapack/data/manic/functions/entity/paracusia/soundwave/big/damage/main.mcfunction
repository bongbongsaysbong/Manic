...
execute as @a[distance=..2,gamemode=!spectator,gamemode=!creative] run function manic:entity/paracusia/soundwave/big/damage/as_player with storage manic:storage root.temp.damage
