execute if entity @s[advancements={manic:technical/consume_item/sanity={very_bad=true}}] run scoreboard players set @s manic.food_sanity 1
execute if entity @s[advancements={manic:technical/consume_item/sanity={bad=true}}] run scoreboard players set @s manic.food_sanity 2
execute if entity @s[advancements={manic:technical/consume_item/sanity={neutral=true}}] run scoreboard players set @s manic.food_sanity 3
execute if entity @s[advancements={manic:technical/consume_item/sanity={good=true}}] run scoreboard players set @s manic.food_sanity 4
execute if entity @s[advancements={manic:technical/consume_item/sanity={very_good=true}}] run scoreboard players set @s manic.food_sanity 5
