...
# RNG
execute store result score #rng_x manic.dummy run random value 1..6 manic:rng/1..6
execute if score #rng_x manic.dummy matches 4.. run scoreboard players remove #rng_x manic.dummy 6

execute store result score #rng_y manic.dummy run random value 1..4 manic:rng/1..4
execute if score #rng_y manic.dummy matches 3.. run scoreboard players remove #rng_y manic.dummy 4

execute store result score #rng_z manic.dummy run random value 1..6 manic:rng/1..6
execute if score #rng_z manic.dummy matches 4.. run scoreboard players remove #rng_z manic.dummy 6
