...
execute as @a[distance=..16,gamemode=!spectator] unless score @s manic.insight > #insight manic.dummy run function manic:block/anirrum_altar/interact/player/copy_insight
