...
execute as @e[type=item_display,tag=manic.deepslate_podium.full,nbt={item:{tag:{manic:{podium_item:{id:"minecraft:emerald"}}}}},distance=..4,limit=1] at @s run function manic:block/deepslate_altar/interact/rituals/technical/delete_item
