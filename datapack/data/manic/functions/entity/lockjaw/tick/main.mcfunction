...
execute if score @s nucleus.frames matches 5 run function manic:entity/lockjaw/animation_end
execute if score @s[tag=manic.lockjaw.bite] nucleus.frames matches 11 run function manic:entity/lockjaw/tick/damage
