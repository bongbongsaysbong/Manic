...
execute at @s unless predicate manic:entity/spectre/spawn_valid/reinforcement if score #attempts manic.dummy matches 10.. run function manic:item/grimoire/render/spawning/as_marker/main_loop
