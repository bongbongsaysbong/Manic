...
execute as @e[type=armor_stand,tag=manic.deepslate_podium.full,nbt={ArmorItems:[{},{},{},{tag:{manic:{podium_item:{id:"minecraft:emerald"}}}}]},distance=..3,limit=1] at @s run function manic:block/deepslate_altar/interact/rituals/technical/delete_item
