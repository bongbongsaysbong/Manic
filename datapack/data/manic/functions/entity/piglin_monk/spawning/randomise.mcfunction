...
# RNG
execute store result score #rng_x manic.dummy run loot spawn ~ ~ ~ loot manic:technical/rng/1_24
execute if score #rng_x manic.dummy matches 7.. run scoreboard players remove #rng_x manic.dummy 24

execute store result score #rng_z manic.dummy run loot spawn ~ ~ ~ loot manic:technical/rng/1_24
execute if score #rng_z manic.dummy matches 7.. run scoreboard players remove #rng_z manic.dummy 24
...
execute at @s align xyz run function manic:entity/piglin_monk/spawning/checks/main
