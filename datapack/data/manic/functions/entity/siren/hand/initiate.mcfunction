...
# RNG
execute store result score #rng_x manic.dummy run loot spawn ~ ~ ~ loot manic:technical/rng/1_10
execute if score #rng_x manic.dummy matches 5.. run scoreboard players remove #rng_x manic.dummy 10

execute store result score #rng_z manic.dummy run loot spawn ~ ~ ~ loot manic:technical/rng/1_10
