...
execute if data storage manic:storage root.temp{specific:4} run function manic:block/anirrum_altar/interact/player/insight_1
execute if data storage manic:storage root.temp{specific:5} run function manic:block/anirrum_altar/interact/player/insight_2
execute if data storage manic:storage root.temp{specific:6} run function manic:block/anirrum_altar/interact/player/insight_4
...
execute if data storage manic:storage root.temp{altar_error:6} run data modify storage smithed.actionbar:input message set value {freeze:45,priority:'notification',json:'{"color":"red","translate":"ui.manic.anirrum_altar.reject.placement"}'}
