execute if entity @s[tag=manic.postgen.sponge_fix] run function manic:technical/postgen/sponge_fix/second_clock
execute if entity @s[tag=manic.postgen.grimoire] run function manic:technical/postgen/grimoire/second_clock
execute if entity @s[tag=manic.postgen.heretic] run function manic:technical/postgen/heretic/second_clock
execute if entity @s[tag=manic.postgen.zealot] run function manic:technical/postgen/zealot/second_clock
execute if entity @s[tag=manic.postgen.flagellant] run function manic:technical/postgen/flagellant/second_clock
