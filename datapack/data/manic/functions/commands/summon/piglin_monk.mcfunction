execute as @e[type=minecraft:wandering_trader,tag=manic.piglin_monk,tag=!manic.piglin_monk.player_spawned] at @s run function manic:entity/piglin_monk/despawn/main
