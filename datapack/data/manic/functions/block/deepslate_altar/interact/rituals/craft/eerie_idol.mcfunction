...
execute as @e[type=item_display,tag=manic.deepslate_podium.full,nbt={item:{tag:{manic:{podium_item:{id:"minecraft:structure_block",tag:{manic:{id:"grimstone_chunk"}}}}}}},distance=..4,limit=3] at @s run function manic:block/deepslate_altar/interact/rituals/technical/delete_item
...
loot spawn ~ ~1 ~ loot manic:items/eerie_idol
