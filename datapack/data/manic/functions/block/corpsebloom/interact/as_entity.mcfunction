...
execute if data storage nucleus:storage root.temp.item{id:"minecraft:glass_bottle"} if score @s manic.dummy2 matches 3 run function manic:block/corpsebloom/interact/bottle_sap/main
