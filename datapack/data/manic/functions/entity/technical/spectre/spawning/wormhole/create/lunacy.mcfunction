...
execute if predicate manic:location/dimension/spawn/spook unless block ~ ~ ~ #nucleus:underwater unless block ~ ~-1 ~ #nucleus:underwater if block ~ ~-1 ~ #nucleus:air run function manic:commands/summon/sorrowhead
...
execute if predicate manic:location/dimension/spawn/eidolon run function manic:commands/summon/lockjaw
