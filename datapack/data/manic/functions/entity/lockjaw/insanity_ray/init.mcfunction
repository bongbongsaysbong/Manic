data merge entity @s {Marker:1b,Invisible:1b,Tags:["nucleus.entity","manic.tick","manic.lockjaw_insanity_ray","manic.entity_component"],ArmorItems:[{},{},{},{id:"minecraft:potion",Count:1b,tag:{CustomModelData:8360032}}]}
