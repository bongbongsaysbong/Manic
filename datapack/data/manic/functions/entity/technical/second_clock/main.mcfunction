execute if entity @s[tag=manic.postgen] run return run function manic:entity/technical/second_clock/postgen
...
execute if entity @s[tag=manic.residuum.stalker] run function manic:entity/events/stalker/second_clock
execute if entity @s[tag=manic.horror_seeker.eye] run function manic:block/horror_seeker/second_clock
