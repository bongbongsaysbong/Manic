...
execute as @e[type=#manic:keeper_target,dx=0] run damage @s 12 manic:melted/bypasses_enchants by @e[type=minecraft:item_display,tag=manic.keeper.display,sort=nearest,limit=1]
