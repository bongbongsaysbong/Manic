...
execute unless entity @e[type=wandering_trader,tag=manic.eidolon,tag=manic.entity.despawns,distance=..32] run function manic:entity/lockjaw/spawning/as_entity
