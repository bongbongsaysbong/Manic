...
execute unless data storage manic:storage root.temp.transform if data entity @s ArmorItems[3].tag.nucleus.custom_model_data.anim.spawn run tp @s ~ ~ ~ facing entity @p[gamemode=!spectator]
