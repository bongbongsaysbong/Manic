...
execute unless entity @s[tag=manic.ritual_success] if data storage manic:storage root.gamerules{legacy_sanity:1b} if score #sanity manic.dummy matches ..2999 unless score #manic.spawning.insomniac manic.dummy matches 1.. if predicate manic:location/dimension/overworld if score #emerald manic.dummy matches 1 if score #rotten_flesh manic.dummy matches 1 if score #necroplasm manic.dummy matches 2 run function manic:block/anirrum_altar/interact/rituals/craft/insomniac
execute unless entity @s[tag=manic.ritual_success] if data storage manic:storage root.gamerules{legacy_sanity:0b} unless score #manic.spawning.insomniac manic.dummy matches 1.. if predicate manic:location/dimension/overworld if score #emerald manic.dummy matches 1 if score #rotten_flesh manic.dummy matches 1 if score #necroplasm manic.dummy matches 2 run function manic:block/anirrum_altar/interact/rituals/craft/insomniac
execute unless entity @s[tag=manic.ritual_success] if data storage manic:storage root.gamerules{legacy_sanity:1b} if score #sanity manic.dummy matches ..4999 unless score #manic.spawning.piglin_monk manic.dummy matches 1.. if predicate manic:location/dimension/the_nether if score #insight manic.dummy matches 2.. if score #gold_ingot manic.dummy matches 1 if score #rotten_flesh manic.dummy matches 1 if score #necroplasm manic.dummy matches 2 run function manic:block/anirrum_altar/interact/rituals/craft/piglin_monk
execute unless entity @s[tag=manic.ritual_success] if data storage manic:storage root.gamerules{legacy_sanity:0b} unless score #manic.spawning.piglin_monk manic.dummy matches 1.. if predicate manic:location/dimension/the_nether if score #insight manic.dummy matches 2.. if score #gold_ingot manic.dummy matches 1 if score #rotten_flesh manic.dummy matches 1 if score #necroplasm manic.dummy matches 2 run function manic:block/anirrum_altar/interact/rituals/craft/piglin_monk
