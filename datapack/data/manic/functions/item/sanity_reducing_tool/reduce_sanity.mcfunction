...
execute if data storage manic:storage root.temp.item.tag.Enchantments[{lvl:1s,id:"minecraft:unbreaking"}] if predicate nucleus:chance/0.75 run scoreboard players remove @s manic.dummy 5
execute if data storage manic:storage root.temp.item.tag.Enchantments[{lvl:2s,id:"minecraft:unbreaking"}] if predicate nucleus:chance/0.6 run scoreboard players remove @s manic.dummy 5
execute if data storage manic:storage root.temp.item.tag.Enchantments[{lvl:3s,id:"minecraft:unbreaking"}] if predicate nucleus:chance/0.45 run scoreboard players remove @s manic.dummy 5
execute if data storage manic:storage root.temp.item.tag.Enchantments[{lvl:4s,id:"minecraft:unbreaking"}] if predicate nucleus:chance/0.3 run scoreboard players remove @s manic.dummy 5
