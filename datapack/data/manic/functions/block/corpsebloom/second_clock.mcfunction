...
execute if score @s manic.dummy2 matches 2.. as @e[distance=..8,predicate=manic:entity/snare/can_be_snared,tag=!manic.snared,tag=!nucleus.animating] at @s run function manic:block/corpsebloom/snare/ensnare
