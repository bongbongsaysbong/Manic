...
execute at @s unless predicate manic:entity/spectre/spawn_valid/reinforcement unless score #iterate manic.dummy matches 10.. run function manic:entity/phobos/spawning/loop
