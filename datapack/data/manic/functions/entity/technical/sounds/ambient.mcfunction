execute if entity @s[tag=manic.spook] run playsound manic:entity.spook.ambient hostile @a
execute if entity @s[tag=manic.revenant] run playsound manic:entity.revenant.ambient hostile @a
execute if entity @s[tag=manic.mirage] run playsound manic:entity.mirage.ambient hostile @a
