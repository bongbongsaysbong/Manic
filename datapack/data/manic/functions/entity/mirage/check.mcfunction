...
execute if entity @s[tag=nucleus.has_line_of_sight] run tag @s add manic.mirage.pre_charge
execute if entity @s[tag=nucleus.has_line_of_sight] run playsound manic:entity.mirage.prepare_dash hostile @a[distance=..16] ~ ~ ~ 1.2
