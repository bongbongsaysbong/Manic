...
# RNG
execute store result score #rng_x manic.dummy run random value 1..24 manic:rng/1..24
execute if score #rng_x manic.dummy matches 7.. run scoreboard players remove #rng_x manic.dummy 24

execute store result score #rng_z manic.dummy run random value 1..24 manic:rng/1..24
