...
execute if score @s[tag=manic.flagellant.attacking] nucleus.frames matches 13 run function manic:entity/flagellant/animation_end/attack
execute if score @s nucleus.frames matches 5 run function manic:entity/flagellant/animation_end/main
