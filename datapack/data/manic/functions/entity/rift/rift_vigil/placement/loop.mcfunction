...
execute if score #loops manic.dummy matches 30.. run return 0
...
function manic:entity/rift/rift_vigil/placement/raycast/main with storage manic:storage root.temp.macro
execute unless score #success manic.dummy matches 1 run function manic:entity/rift/rift_vigil/placement/loop
