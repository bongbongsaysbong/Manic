...
execute as @e[type=interaction,tag=manic.corpsethorn,distance=..7,nbt={interaction:{}}] at @s run function manic:block/corpsethorn/interact/as_entity
...
execute if data storage manic:storage root.temp{result:"bottle_sap"} run function manic:block/corpsethorn/interact/bottle_sap/as_player
execute if data storage manic:storage root.temp{result:"fill_sap"} run function manic:block/corpsethorn/interact/fill_sap/as_player
