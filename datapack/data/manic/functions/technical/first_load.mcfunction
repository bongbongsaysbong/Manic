...
data modify storage manic:storage root.version.release set value 2
data modify storage manic:storage root.version.semiver set value 1
...
data modify storage manic:storage root.gamerules.horror_ward_forceloading set value 0b
