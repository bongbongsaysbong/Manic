...
execute as @a[dx=0] run function manic:entity/necromorph/acid/damage/as_player with storage manic:storage root.temp.damage
tag @s remove manic.damager

kill @s
playsound manic:entity.necromorph.acid hostile @a[distance=..16]
