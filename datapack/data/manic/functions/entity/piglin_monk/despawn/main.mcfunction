...
execute as @e[type=minecraft:hoglin,tag=manic.piglin_monk_hoglin] at @s run function manic:entity/piglin_monk/despawn/as_baby_hoglin

playsound manic:entity.piglin_monk.despawn neutral @a[distance=..16]
