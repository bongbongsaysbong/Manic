...
data modify storage manic:storage root.temp.reduce_sanity set value 5000
data modify storage manic:storage root.temp.specific set value 6
scoreboard players set #sanity_charges manic.dummy 3
scoreboard players set #ritual_id manic.dummy 26
