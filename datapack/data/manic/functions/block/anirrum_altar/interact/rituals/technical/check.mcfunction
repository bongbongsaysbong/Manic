...
execute unless entity @s[tag=manic.ritual_success] if score @s manic.dummy matches 3.. if score #disc_fragment manic.dummy matches 4 run function manic:block/anirrum_altar/interact/rituals/craft/disc_7
